...
const DashboardView = ({ onSignOut }) => {
  ...
  const handleSearch = async (e) => {
    ...
    // Add to past searches immediately
  ...
  const handleSelection = (id) => {
    // Set only the selected interest (no array, just single selection)
    setSelectedInterests([id]);
    // Immediately show the roadmap interface
    setShowMainInterface(true);
  };
  ...
  return (
    ...
    >
      ...
      {showMainInterface ? (
        <RoadmapInterface 
          onClose={() => setShowMainInterface(false)}
        />
      ) : (
        <motion.div 
                    ...
                    pastSearches.map((search, index) => (
                      <motion.div
                        ...
                        onClick={() => {
                          ...
                          // Show main interface when clicking past search
                          setShowMainInterface(true);
                        }}
                      >
